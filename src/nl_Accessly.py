...
def check_server() -> bool:
    # from lib.util import get_accessly_status
...
def run_updater(force: bool = False):
    from lib.util import duplicate_file, run_elevated
...
def run_kiosk():
    ...
    check_files()
    run_updater()
    from lib.util import run_normally, is_crash_loop, kill_processes
